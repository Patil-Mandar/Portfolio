export default function AIBadge() {
  return (
    <a
      href="#"
      className="fixed bottom-4 left-4 z-40 rounded-full px-3 py-1.5 text-xs font-medium bg-white/5 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur hover:opacity-90 inline-flex items-center gap-1.5"
      aria-label="Built with AI assistance"
    >
